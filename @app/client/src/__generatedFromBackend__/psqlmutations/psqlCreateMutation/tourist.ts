export const mutation = `mutation createTourist(,$touristFirstName: String ,$touristLastName: String ,$contactId: Int! ,$publisherId: Int! ,$createdById: Int! ,$nativeLanguage: Languages ,$alternativeLanguage: Languages ,$touristOfferId: Int! ,$touristFavoriteId: Int! ,$touristBidId: Int! ,$touristDealId: Int! ,$guideReviewInIdPool: [Int] ,$agencyReviewInIdPool: [Int] ,$guideReviewOutIdPool: [Int] ,$agencyReviewOutIdPool: [Int] ,$timeCreated: Datetime ,$atTravelGroup: Int ,$isActive: Boolean , $clientMutationId: String!) {
        __typename
