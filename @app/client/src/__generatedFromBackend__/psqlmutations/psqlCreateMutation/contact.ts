export const mutation = `mutation createContact(,$firstName: String ,$lastName: String ,$associatedCompany: String ,$street: String ,$city: String ,$postCode: String ,$country: String ,$telephone: String ,$email: String ,$isCompany: Boolean ,$createdById: Int ,$belongsToType: Resourcetype ,$belongsToId: Int ,$timeCreated: Datetime , $clientMutationId: String!) {
        __typename
