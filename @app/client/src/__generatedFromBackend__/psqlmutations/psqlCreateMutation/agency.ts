export const mutation = `mutation createAgency(,$name: String! ,$contactId: Int ,$activeInsurance: Boolean! ,$insuranceUrl: String ,$insuranceExpery: Date ,$publisherId: Int ,$createdById: Int! ,$isActive: Boolean ,$isPublic: Boolean ,$agencyBidId: Int ,$agencyFavoriteId: Int ,$agencyOfferId: Int ,$agencyDealId: Int ,$trustedPartnerIdPool: [Int] ,$extendedNetworkIdPool: [Int] ,$guideReviewInIdPool: [Int] ,$agencyReviewInIdPool: [Int] ,$touristReviewInIdPool: [Int] ,$guideReviewOutIdPool: [Int] ,$agencyReviewOutIdPool: [Int] ,$touristReviewOutIdPool: [Int] ,$agencyMediaLibraryId: Int ,$isRomanian: Boolean! ,$bookingCalendarId: Int ,$specializedAgency: Resourcetype ,$lastModified: Datetime ,$timeCreated: Datetime , $clientMutationId: String!) {
        __typename
