export const mutation = `mutation createGuide(,$name: String ,$contactId: Int! ,$hasGuideLicence: Boolean! ,$guideLicenceUrl: String ,$publisherId: Int! ,$createdById: Int! ,$guideFirstName: String ,$guideLastName: String ,$hasOwnCompany: Boolean! ,$atAgency: Int ,$languageLevelId: Int! ,$areas: [Area]! ,$tripTypeName: String ,$guideOfferId: Int! ,$guideBidId: Int! ,$guideFavoriteId: Int! ,$guideDealId: Int! ,$agencyReviewInIdPool: [Int] ,$touristReviewInIdPool: [Int] ,$agencyReviewOutIdPool: [Int] ,$touristReviewOutIdPool: [Int] ,$bookingCalendarId: Int! ,$hostIdPool: [Int] ,$eventIdPool: [Int] ,$accomodationIdPool: [Int] ,$transportIdPool: [Int] ,$lastModified: Datetime ,$timeCreated: Datetime ,$isActive: Boolean ,$isPublic: Boolean! , $clientMutationId: String!) {
        __typename
