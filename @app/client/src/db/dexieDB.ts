...
// import { uploadImageToS3 } from 'src/functions/fetch/fetchImagefromS3';
// import { APPSTATE } from 'src/redux/types/types';
import { GetMyDestinationQuery } from "*/destinationquery.graphql";
import {
  UpdateDestinationMutation,
  useUpdateDestinationMutation,
} from "*/updateDestination.graphql";
...
class clientDB extends Dexie {
  ...
  public mediadestinationresource?: Dexie.Table<
    mediadestinationresourceDbType,
    number
  >;
  ...
  public similarbytriptypeaccomodation?: Dexie.Table<
    similarbytriptypeaccomodationDbType,
    number
  >;
  public similarbytriptypedestination?: Dexie.Table<
    similarbytriptypedestinationDbType,
    number
  >;
  public similarbytriptypeevent?: Dexie.Table<
    similarbytriptypeeventDbType,
    number
  >;
  public similarbytriptypeguide?: Dexie.Table<
    similarbytriptypeguideDbType,
    number
  >;
  public similarbytriptypehost?: Dexie.Table<
    similarbytriptypehostDbType,
    number
  >;
  public similarbytriptypetransport?: Dexie.Table<
    similarbytriptypetransportDbType,
    number
  >;
  public similarbytriptypetravelgroup?: Dexie.Table<
    similarbytriptypetravelgroupDbType,
    number
  >;
  ...
  constructor() {
    ...
    this.similarbytriptypeaccomodation = this.table(
      "similarbytriptypeaccomodation"
    );
    this.similarbytriptypedestination = this.table(
      "similarbytriptypedestination"
    );
    ...
    this.similarbytriptypetravelgroup = this.table(
      "similarbytriptypetravelgroup"
    );
    ...
    this.similarbytriptypeaccomodation.mapToClass(
      SimilarbytriptypeaccomodationDbClass
    );
    this.similarbytriptypedestination.mapToClass(
      SimilarbytriptypedestinationDbClass
    );
    ...
    this.similarbytriptypetransport.mapToClass(
      SimilarbytriptypetransportDbClass
    );
    this.similarbytriptypetravelgroup.mapToClass(
      SimilarbytriptypetravelgroupDbClass
    );
