...
timeCreated?: string;
 nodeId?: string;
  ...
  constructor(transportIds?: number[],--?: string,resource?: string,eventres?: string,accomodationres?: string,hostres?: string,transportres?: string,app_public.guideres?: string,app_public.tourist??: string,travelgroup?]?: string,atAgency?: number,timeCreated?: string, nodeId?: string,) {
