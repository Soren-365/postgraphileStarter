...
timeCreated?: string;
 nodeId?: string;
  ...
  constructor(id?: number,publisherId: number,createdById: number,isActive?: boolean,halfStars?: number,reviewText?: string,guideIdTarget: number,startDateTripEvent?: string,byRomanian?: boolean,timeCreated?: string, nodeId?: string,) {
    this.id = id
