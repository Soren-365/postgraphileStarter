...
createdById: number;
 nodeId?: string;
  ...
  constructor(id?: number,locationLat?: number,locationLng?: number,locationType?: string,placesId?: string,formattedAdress?: string,type?: string,viewportNorthEastLat?: number,viewportNorthEastLng?: number,viewportSouthWestLat?: number,viewportSouthWestLng?: number,createdById: number, nodeId?: string,) {
    this.id = id
