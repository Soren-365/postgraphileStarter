...
export default interface apiDbTypes {
  triptype: triptypeDbType;
  usertable: usertableDbType;
  account: accountDbType;
  contact: contactDbType;
  commandlogentry: commandlogentryDbType;
  publisher: publisherDbType;
  geocoding: geocodingDbType;
  accounting: accountingDbType;
  presentation: presentationDbType;
  bid: bidDbType;
  auctioninfo: auctioninfoDbType;
  priceinfo: priceinfoDbType;
  calendarentry: calendarentryDbType;
  timerange: timerangeDbType;
  bookingcalendar: bookingcalendarDbType;
  accomodationresource: accomodationresourceDbType;
  destinationresource: destinationresourceDbType;
  eventresource: eventresourceDbType;
  tripofferresource: tripofferresourceDbType;
  roomcalendarentry: roomcalendarentryDbType;
  roomcalendar: roomcalendarDbType;
  roomlist: roomlistDbType;
  transportresource: transportresourceDbType;
  review: reviewDbType;
  hostresource: hostresourceDbType;
  tourist: touristDbType;
  languagelevel: languagelevelDbType;
  guideresource: guideresourceDbType;
  guide: guideDbType;
  agency: agencyDbType;
  medialocation: medialocationDbType;
  touristresource: touristresourceDbType;
  travelgroupresource: travelgroupresourceDbType;
  agencyaccomodation: agencyaccomodationDbType;
  agencyevent: agencyeventDbType;
  agencyguide: agencyguideDbType;
  agencyhost: agencyhostDbType;
  agencytourist: agencytouristDbType;
  agencytransport: agencytransportDbType;
  agencytravelgroup: agencytravelgroupDbType;
  agencytripoffer: agencytripofferDbType;
  agencyuser: agencyuserDbType;
  mediadestinationresource: mediadestinationresourceDbType;
  agencyreview: agencyreviewDbType;
  guidereview: guidereviewDbType;
  agencybid: agencybidDbType;
  agencymedialibrary: agencymedialibraryDbType;
  agencydeal: agencydealDbType;
  agencyfavorite: agencyfavoriteDbType;
  agencyoffer: agencyofferDbType;
  date_: date_DbType;
  guidebid: guidebidDbType;
  guidedeal: guidedealDbType;
  guidefavorite: guidefavoriteDbType;
  guideoffer: guideofferDbType;
  touristbid: touristbidDbType;
  touristdeal: touristdealDbType;
  touristfavorite: touristfavoriteDbType;
  touristoffer: touristofferDbType;
  touristreview: touristreviewDbType;
  similarbytriptypeaccomodation: similarbytriptypeaccomodationDbType;
  similarbytriptypedestination: similarbytriptypedestinationDbType;
  similarbytriptypeevent: similarbytriptypeeventDbType;
  similarbytriptypeguide: similarbytriptypeguideDbType;
  similarbytriptypehost: similarbytriptypehostDbType;
  similarbytriptypetransport: similarbytriptypetransportDbType;
  similarbytriptypetravelgroup: similarbytriptypetravelgroupDbType;
  assocaccomodation: assocaccomodationDbType;
  assochost: assochostDbType;
  assocguide: assocguideDbType;
  assoctransport: assoctransportDbType;
  assocevent: assoceventDbType;
  assocdestination: assocdestinationDbType;
  assoctravelgroup: assoctravelgroupDbType;
}
